 DIEGO GIROTTI, &nbsp; Sr. Manual Quality Assurance | Certified Scrum Master
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Contact Information
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
- _QA Tools:_ TestLink, TestRail, Azure DevOps, Rainforest, TestIO, Zephyr Scale, BrowserStack, Postman, Newman, Jira, Confluence, Launchdarkly, Buildkite, Firebase, Git, GitHub, SQL Server, Dynamo DB, Postgres, Figma, InVision, Miro, Cypress, Swagger, Jenkins, Teams, TestFlight. 
...
- Report, track, and validate defects using Azure DevOps to ensure timely resolution.

- Collaborate closely with developers, product owners, and designers to ensure product quality and feature readiness.

- Conduct API testing and database validations to verify data integrity and backend logic.
...
[Profile Overview](https://github.com/dgirotti/dgirotti/blob/main/Diego%20Girotti%20Professional%20Overview-1.pdf) &nbsp; &nbsp; &nbsp;[Feedback](https://github.com/dgirotti/dgirotti/blob/main/Feedback.pdf) &nbsp; &nbsp; &nbsp;[References](https://github.com/dgirotti/dgirotti/blob/main/References.pdf)
